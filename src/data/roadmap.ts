 ...
 *
 * A pagina /escolinha ainda desenha o roteiro dela com markup proprio, em
...
export const etapasRoadmap: EtapaRoadmap[] = [
  { numero: 1,  titulo: 'Fundamentos de SEO',                     grupo: 'base',    href: '/escolinha/iniciante' },
  { numero: 2,  titulo: 'Execute um processo de SEO',             grupo: 'base',    href: '/escolinha/iniciante' },
  { numero: 3,  titulo: 'SEO no seu CMS',                         grupo: 'base',    href: '/escolinha/tecnica' },
  { numero: 4,  titulo: 'Aprofunde seus conhecimentos de SEO',    curto: 'Aprofunde seus conhecimentos', grupo: 'base', href: '/escolinha/tecnica' },
  { numero: 5,  titulo: 'Especialista em SEO',                    grupo: 'tecnica', href: '/escolinha/tecnica' },
  { numero: 6,  titulo: 'Auditoria técnica de SEO',               grupo: 'tecnica', href: '/escolinha/tecnica' },
  { numero: 7,  titulo: 'SEO em outros mecanismos de busca',      curto: 'SEO em outros mecanismos', grupo: 'tecnica', href: '/escolinha/tecnica' },
  { numero: 8,  titulo: 'SEO local',                              grupo: 'tecnica', href: '/escolinha/tecnica' },
  { numero: 9,  titulo: 'Otimização para IA (GEO/AEO)',           grupo: 'ia',      href: '/escolinha/geo-aeo' },
  { numero: 10, titulo: 'Complemente seu SEO',                    grupo: 'ia',      href: '/escolinha/geo-aeo' },
  { numero: 11, titulo: 'Ferramentas de SEO gratuitas',           grupo: 'ia',      href: '/ferramentas' },
  { numero: 12, titulo: 'Trends, testes e soluções de problemas', curto: 'Trends, testes e problemas', grupo: 'ia', href: '/escolinha' },
];
 ...
 * JavaScript rodar. Quando a /escolinha comecar a gravar o progresso real,
...
/** chave do localStorage combinada com a /escolinha */
